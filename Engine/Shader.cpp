...
void Shader::CreateGraphicsShader(const wstring& path, ShaderInfo info, const string& vs, const string& ps, const string& gs)
{
	...
	D3D12_INPUT_ELEMENT_DESC desc[] = {
		...
		/*
		* float4 * 4 행렬을 넘겨주기 위해 만들어짐. //check- defered.fx file.  VS_IN cord
		* InputSlot 0~15번까지 사용가능. 아래는 1번 slot
		* 
		*/
	...
	_graphicsPipelineDesc.DSVFormat = DXGI_FORMAT_D32_FLOAT; //Depth용 32
